...
class Triangulo:
    ...
    def __init__(el_triangulo_en_cuestion):
        """
        Por hacer: hay que poner las características del triangulo
        """
        print("Hola, estoy creando un triángulo")
        pass

    def obtener_superficie(el_triangulo_en_cuestion):
        print("Hola, estoy calculando la superficie de un triángulo")
...
triangulo = Triangulo()
print("2")
print(triangulo.obtener_superficie())
